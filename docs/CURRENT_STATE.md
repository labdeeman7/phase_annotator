...
- Delete/merge choices, boundary editing, and undo/redo are not implemented yet. C3.2 compact notes and C3.3 whole-segment relabeling are implemented and manually accepted.
...
Implement C3.4 precise shared-boundary correction through set-start/set-end-to-playhead actions.
